...
var rgba = exports.rgba = function rgba(hex, alpha) {
...
var randomColor = exports.randomColor = function randomColor(colors) {
...
var PhysicsObject = function () {
  ...
  _createClass(PhysicsObject, [{
    ...
    value: function drawFill() {
      if (this.fill) {
        this.c.fillStyle = (0, _helpers.rgba)(this.fillColor, this.alpha);
        this.c.fill();
      }
      if (this.stroke) {
        this.c.strokeStyle = (0, _helpers.rgba)(this.strokeColor, this.alpha);
...
var _PhysicsObject2 = __webpack_require__(1);

var _PhysicsObject3 = _interopRequireDefault(_PhysicsObject2);
...
var Ball = function (_PhysicsObject) {
  _inherits(Ball, _PhysicsObject);
  ...
  function Ball(options) {
    ...
    _this.adjustmentY = options.radius;
    _this.adjustmentX = options.radius;
    return _this;
  }
...
var Square = function (_PhysicsObject) {
  _inherits(Square, _PhysicsObject);
  ...
  function Square(options) {
    ...
    _this.adjustmentX = options.width;
    _this.adjustmentY = options.height;
    return _this;
  }
...
var strokecolors = ['#FFFFFF', '#CD8700', '#9D6100', '#FDB014', '#4E1900'];
var colors = ['#FFFFFF', '#8f98ff', '#ff5151', '#ffc48b', '#8bd7ff'];
//const colors = ['#FFFFFF']
...
function createRandomFromMouse() {
  var width = (0, _helpers.randomIntFromRange)(vars.minSize, vars.maxSize);
  var height = (0, _helpers.randomIntFromRange)(vars.minSize, vars.maxSize);
  var radius = (0, _helpers.randomIntFromRange)(vars.minSize, vars.maxSize);
  var x = (0, _helpers.randomIntFromRange)(mouse.x - 25, mouse.x + 25);
  var y = (0, _helpers.randomIntFromRange)(mouse.y - 25, mouse.y + 25);
  var dx = (0, _helpers.randomIntFromRange)(-8, 8);
  var dy = (0, _helpers.randomIntFromRange)(-8, 8);
  if (shape == "ball") {
    var color = (0, _helpers.randomColor)(colors);
    var strokeColor = (0, _helpers.randomColor)(colors);
    balls.push(new _Ball2.default({ x: x, y: y, dx: dx, dy: dy, radius: radius, color: color, strokeColor: strokeColor, stroke: true, canvas: canvas, ygravity: vars.ygravity, xgravity: vars.xgravity, friction: vars.friction, alphaDegrade: vars.alphaDegrade }));
  } else {
    var _color = (0, _helpers.randomColor)(strokecolors);
    var _strokeColor = (0, _helpers.randomColor)(strokecolors);
    balls.push(new _Square2.default({ x: x, y: y, dx: dx, dy: dy, width: width, height: height, color: _color, fill: false, stroke: true, canvas: canvas, ygravity: vars.ygravity, xgravity: vars.xgravity, friction: vars.friction, alphaDegrade: vars.alphaDegrade }));
  }
}
